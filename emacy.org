...
** TODO jira
   ox-confluence
** WILL [[https://github.com/manateelazycat/fingertip][fingertip]] :lazycat:treesit:
** TODO [[https://github.com/alphapapa/dogears.el][dogears]]
** misc
...
** exec-path
#+BEGIN_SRC emacs-lisp
  (setq exec-path (append '("~/.emacs.d/env/python/.venv/bin" "~/.emacs.d/env/node/node_modules/.bin" "~/.bun/bin" "~/.local/bin") exec-path))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package no-littering
    ...
    (let ((dir (no-littering-expand-var-file-name "locks")))
...
*** QUIT [[https://github.com/karthink/popper][popper]]
...
#+end_src
**** nerd-icon-completion                                              :completion:
#+begin_src emacs-lisp
...
**** nerd-icons-dired  :icon:nerdicons:
#+begin_src emacs-lisp :tangle no
...
#+end_src
*** indent
**** QUIT highlight-indent-guides
#+begin_src emacs-lisp :tangle no
  (use-package highlight-indent-guides
    :hook (prog-mode . highlight-indent-guides-mode)
    :custom (highlight-indent-guides-method 'fill))
#+end_src
**** [[https://github.com/jdtsmith/indent-bars][indent-bars]]                                                    :treesit:
#+begin_src emacs-lisp
...
#+end_src
** misc
*** TODO [[https://github.com/manateelazycat/holo-layer][holo-layer]] :lazycat:
#+begin_src emacs-lisp :tangle no
  ;; FIXME: scale & focus
  (use-package holo-layer
    ...
    (setq holo-layer-type-animation-style "matrix")
...
#+begin_src emacs-lisp
  (use-package combobulate
    ...
    :hook
    (((python-ts-mode js-ts-mode typescript-ts-mode tsx-ts-mode json-ts-mode html-ts-mode css-ts-mode) . combobulate-mode)))
#+end_src
* Complete
** vertico
#+BEGIN_SRC emacs-lisp
...
#+begin_src emacs-lisp
  ...
  (setq org-capture-templates
        '(("t" "Todo" entry (file "~/Notes/inbox.org")
           "* TODO %^{Name}")
          ("w" "Work" entry (file "~/Notes/work/task.org")
           "* TODO %^{Name}")
          ("j" "Journal" entry (file+datetree "~/Notes/journal/index.org")
           "* %U - %^{heading} %^g\n %?\n")))
...
#+begin_src emacs-lisp
  (use-package org-super-agenda
    ...
    (setq org-super-agenda-groups
          '((:name "Next" :time-grid t :todo "NEXT")
...
#+begin_src emacs-lisp
  ...
  (define-derived-mode nushell-mode prog-mode "nusehll mode")
...
#+begin_src emacs-lisp
  ...
  (use-package ob-racket
    :after org
    :config
    (add-hook 'ob-racket-pre-runtime-library-load-hook #'ob-racket-raco-make-runtime-library)
    (org-babel-do-load-languages
     'org-babel-load-languages
     '((racket . t))))
#+end_src
...
#+end_src
*** TODO use buildin track-changes
** lsp
*** lsp-bridge :lazycat:
#+begin_src emacs-lisp :tangle no
...
#+begin_src emacs-lisp
  (use-package eglot
    :hook ((prog-mode . (lambda () (unless (derived-mode-p 'emacs-lisp-mode 'lisp-mode) (eglot-ensure)))))
    :init
...
** configs
*** [[https://github.com/redguardtoo/emacs.d][redguardtoo]] :org:
...
*** [[https://github.com/sachac/.emacs.d/][sachac]] :org:
*** [[https://github.com/Eason0210/.emacs.d][Eason0210]] :borg:eglot:
*** [[https://github.com/HerculeWu/HubbleEmacs/blob/main/Emacs.org][HerculeWu]] :org:
*** [[https://github.com/nowislewis/nowisemacs/blob/master/init.org][nowisemacs]] :org:
*** [[https://github.com/seagle0128/.emacs.d][centaur emacs]]
*** [[https://github.com/nasyxx/emacs.d][nasyxx]]
*** [[https://github.com/MatthewZMD/.emacs.d][MatthewZMD]]
*** [[https://github.com/condy0919/.emacs.d][condy0919]]
*** [[https://remacs.fun/][remacs]] :org:blog:
