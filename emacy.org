...
** Variable
#+BEGIN_SRC emacs-lisp
  (defvar local-emacs-directory "~/.local/share/emacs/" "User's local directory for emacs, ~/.local/emacs/")
  (defvar elpaca-directory local-emacs-directory)
  (defvar elpaca-repos-directory (expand-file-name "lib" user-emacs-directory))
