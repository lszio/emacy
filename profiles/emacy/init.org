...
#+END_SRC
** Constants
baisc constants for operating system
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp :lexical t
  ...
  (defmacro generate-general-global-definer (name infix-key &rest body)
...
**** applications
#+begin_src emacs-lisp
  (generate-general-global-definer "application" "a"
    "p" '(:ignore t "elpaca")
    "pb" 'elpaca-browse
...
**** buffers
#+begin_src emacs-lisp
  (generate-general-global-definer "buffer" "b"
...
**** windows
#+begin_src emacs-lisp
   (generate-general-global-definer "window" "w"
...
**** project
#+begin_src emacs-lisp
  (generate-general-global-definer "project" "p"
    "b" '(:ignore t :which-key "buffer"))
#+end_src
**** others
#+begin_src emacs-lisp
  (generate-general-global-definer "link" "l")

  (generate-general-global-definer "quit" "q"
    "q" 'save-buffers-kill-emacs
    "r" 'restart-emacs
    "Q" 'kill-emacs)

  (generate-general-global-definer "tab" "t")

  (generate-general-global-definer "toggle" "T"
    "d" '(:ignore t :which-key "debug")
    "de" 'toggle-debug-on-error
    "dq" 'toggle-debug-on-quit
    "s" '(:ignore t :which-key "spelling"))

  (generate-general-global-definer "help" "h"
  ...
  (generate-general-global-definer "git/version-control" "g")

  (generate-general-global-definer "frame" "F"
...
**** files
#+begin_src emacs-lisp
  (generate-general-global-definer "file" "f"
