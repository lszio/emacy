...
** TODO which key description override by menu name
eg. description for "SPC a p <xx>" was override by "SPC p" as "project"
...
#+begin_src emacs-lisp :lexical t
  ...
  (emacy-definer
    ...
    "apb" 'elpaca-browse
    "apr" '((lambda () (interactive) (let ((current-prefix-arg (not current-prefix-arg))) (call-interactively #'elpaca-rebuild))) :which-key "rebuild")
    "apm" 'elpaca-manager
    "apl" 'elpaca-log
    "api" 'elpaca-info
    "apI" '((lambda () (interactive) (info "Elpaca")) :which-key "elpaca-info")
    "aps" 'elpaca-status
    "apt" 'elpaca-try
    "apv" 'elpaca-visit
    ...
    "b TAB" '((lambda () (interactive) (switch-to-buffer nil)) :which-key "other-buffer")
