...
#+begin_src emacs-lisp
  ...
  (defvar elpaca-builds-directory (expand-file-name "var/elpaca/builds" (if wsl? user-local-directory user-emacs-directory)))
...
#+begin_src emacs-lisp
  ...
  ;;(setq treesit-extra-load-path (expand-file-name "var/treesit" user-emacs-directory))
