...
* init-keybinds
:PROPERTIES:
:HEADER-ARGS: :tangle lisp/init-keybinds.el :mkdirp yes
:END:

** Header
#+begin_src emacs-lisp
  ;;; init-keybinds.el --- The main init entry for Emacs -*- lexical-binding: t -*-
  ;;; Commentary:
...
** Header
#+begin_src emacs-lisp
  ;;; init-ui.el --- The main init entry for Emacs -*- lexical-binding: t -*-
  ;;; Commentary:
...
** Header
#+begin_src emacs-lisp
  ;;; init-org.el --- The main init entry for Emacs -*- lexical-binding: t -*-
  ;;; Commentary:
...
** Header
#+begin_src emacs-lisp
  ;;; init-edit.el --- The main init entry for Emacs -*- lexical-binding: t -*-
  ;;; Commentary:
...
** Header
#+begin_src emacs-lisp
  ;;; init-ide.el --- The main init entry for Emacs -*- lexical-binding: t -*-
  ;;; Commentary:
...
** Header
#+begin_src emacs-lisp
  ;;; init-misc.el --- The main init entry for Emacs -*- lexical-binding: t -*-
  ;;; Commentary:
...
** Header
#+begin_src emacs-lisp
  ;;; init-completion.el --- The main init entry for Emacs -*- lexical-binding: t -*-
  ;;; Commentary:
