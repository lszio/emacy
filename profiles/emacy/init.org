    ...
    (let* ((build-dir (elpaca<-build-dir e))
      ...
      (dolist (spec files)
        (when-let ((file   (car spec))
          ...
          ;; (ignore-errors (make-symbolic-link file link 'overwrite))
          (condition-case err
             (make-symbolic-link file link 'overwrite)
             (file-already-exists nil)))))
          ;;(make-symbolic-link file link 'overwrite)
          ;;(copy-file file link :ok-if-already-exists 'overwrite)

    (elpaca--continue-build e "Build files linked"))

  (when windows?
    (advice-add 'elpaca--link-build-files :override 'emacy/elpaca--link-build-files))
...
#+begin_src emacs-lisp :lexical t
  (general-define-key
   :keymaps 'override
   :states '(insert normal visual emacs motion operator)
  ...
  (emacy-definer
    ...
    "ap" '(:ignore t :wk "elpaca")
    "apb" 'elpaca-browse
    "apr" '((lambda () (interactive) (let ((current-prefix-arg (not current-prefix-arg))) (call-interactively #'elpaca-rebuild))) :wk "rebuild")
    "apm" 'elpaca-manager
    "apl" 'elpaca-log
    "api" 'elpaca-info
    "apI" '((lambda () (interactive) (info "Elpaca")) :wk "elpaca-info")
    "aps" 'elpaca-status
    "apt" 'elpaca-try
    "apv" 'elpaca-visit
    ...
    "br"  'rename-buffer
    "bR"  'revert-buffer
    "bM" '((lambda () (interactive) (switch-to-buffer "*Messages*")) :wk "messages-buffer")
    "bn"  'next-buffer
    "bs" '((lambda () (interactive) (switch-to-buffer "*scratch*")) :wk "scratch-buffer")
    "b TAB" '((lambda () (interactive) (switch-to-buffer nil)) :wk "other-buffer")

    "w=" 'balance-windows
    "w/" 'split-window-horizontally
    "w?" 'split-window-vertically
    "wO" 'delete-other-windows
    "wX" '((lambda () (interactive) (call-interactively #'other-window) (kill-buffer-and-window)) :wk "kill-other-buffer-and-window")
    ...
    "wl" 'windmove-right
    "wo" 'other-window
    "wt" '((lambda () (interactive) (set-window-dedicated-p (selected-window) (not (window-dedicated-p)))) :wk "toggle window dedication")
    ...
    "fd"   '((lambda (&optional arg)
              (interactive "P")
              (let ((buffer (when arg (current-buffer))))
                (diff-buffer-with-file buffer))) :wk "diff-with-file")
    "fe"   '(:ignore t :wk "edit")
    "fed"  '((lambda () (interactive) (find-file-existing literate-file) (widen)) :wk "dotfile")
    "feR"  '((lambda () (interactive) (load-file user-init-file)) :wk "reload-init.el")
    "fet"  '((lambda ()
              (interactive)
              (save-restriction
                (widen)
            ...
            :wk "tangle/reload-init.el")
    "fl"   '((lambda (&optional arg) (interactive "P") (call-interactively (if arg #'find-library-other-window #'find-library)))
            :wk "+find-library")
